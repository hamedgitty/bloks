...
//
//   A folder that has gone is said out loud. A project carries a list of
//   working directories, and the thing that matters is what happens when
//   one of them moves: falling back to somewhere else is worse than
//   stopping, because an agent quietly writing into the wrong directory
//   is harder to notice than an agent refusing to start.
//
