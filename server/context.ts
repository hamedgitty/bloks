...
/** Past this share of the window, summarise. Berd settled on the same
 * number and it is a reasonable place: late enough that most
 * conversations never reach it, early enough to leave room for the reply. */
